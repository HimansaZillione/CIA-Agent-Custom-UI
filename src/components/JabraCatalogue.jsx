        ...
        <div style={{ padding:'14px 18px', display:'flex', flexDirection:'column', gap:'14px' }}>
          ...
          {tab === 'specs' && (
            <div style={{ display:'flex', flexDirection:'column', gap:'6px' }}>
              {(selected.specs || ['Premium audio quality','Noise cancellation','USB-C & Bluetooth','2-year warranty']).map((s,i) => (
          ...
          <div style={{ display:'flex', gap:'8px' }}>
            <button
              onClick={() => onCta?.(`Tell me more about the Jabra ${selected.label}`)}
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:'12px', padding:'18px' }}>
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between' }}>
        <h3 style={{ margin:0, fontSize:'15px', fontWeight:600, fontFamily:'Outfit,sans-serif', color:'var(--text)' }}>Jabra Devices</h3>
      ...
      <div style={{ display:'flex', flexDirection:'column', gap:'7px' }}>
        {jabraProducts.map(product => (
          ...
          >
            ...
            <div style={{ color:'rgba(233,30,140,0.6)', fontSize:'18px', flexShrink:0, lineHeight:1 }}>›</div>
          </button>
        ))}
      </div>
